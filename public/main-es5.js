  ...
  ['main'],
  {
    ...
    \**************************************/
      ...
      function srcAppCoreCoreModuleTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var CoreModule = function CoreModule(parentModule) {
          ...
          if (parentModule) {
            throw new Error(
              ''.concat(parentModule, ' has already been loaded. Import Core module in the AppModule only.')
            );
          }
        };
    ...
    \**************************************************/
      ...
      function srcAppCoreRouteReusableStrategyTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var ɵRouteReusableStrategy_BaseFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__['ɵɵgetInheritedFactory'](
        ...
        function untilDestroyed(instance) {
          ...
          return function (source) {
            ...
            if (!hasDestroyFunction) {
              throw new Error(
                ''
                  .concat(instance.constructor.name, " is using untilDestroyed but doesn't implement ")
    ...
    \*******************************/
      ...
      function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var _multiplos_multiplos_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ./multiplos/multiplos.module */
      ...
      function srcAppHomeQuoteServiceTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var QuoteService = /*#__PURE__*/ (function () {
          ...
          _createClass(QuoteService, [
            {
              key: 'getRandomQuote',
              value: function getRandomQuote(context) {
    ...
    \**************************************/
      ...
      function srcAppI18nI18nServiceTs(module, __webpack_exports__, __webpack_require__) {
        ...
        var _translations_es_ES_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    \*******************************************************/
      ...
      /***/
      function srcAppMultiplosMultiplosRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';

        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */

        __webpack_require__.d(__webpack_exports__, 'MultiplosRoutingModule', function () {
        ...
        var _multiplos_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./multiplos.component */
        ...
        var routes = [
          _app_shell_shell_service__WEBPACK_IMPORTED_MODULE_4__['Shell'].childRoutes([
            ...
            },
            {
              ...
              data: {
                title: Object(_app_i18n__WEBPACK_IMPORTED_MODULE_2__['extract'])('multiplos'),
              },
            },
          ]),
        ];

        var MultiplosRoutingModule = function MultiplosRoutingModule() {
          _classCallCheck(this, MultiplosRoutingModule);
        };
    ...
    \**************************************************/
      ...
      /***/
      function srcAppMultiplosMultiplosComponentTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';

        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */

        __webpack_require__.d(__webpack_exports__, 'MultiplosComponent', function () {
        ...
        var _services_multiplos_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../services/multiplos.service */
        ...
        var MultiplosComponent = /*#__PURE__*/ (function () {
          function MultiplosComponent(_ms) {
            _classCallCheck(this, MultiplosComponent);
          ...
          _createClass(MultiplosComponent, [
            {
              key: 'ngOnInit',
              value: function ngOnInit() {
            ...
            {
              key: 'consultarMultiplos',
              value: function consultarMultiplos() {
                var _this5 = this;

                this._ms.obtenerMultiplos().subscribe(function (resp) {
                  _this5.multiplos = resp;
                  console.log(resp);

                  _this5.multiplos.forEach(function (mult) {
                    if (mult.multiplo3 != '') {
                      _this5.primerMultiplo = true;
                    }
                  });
                });
              },
            ...
            {
              key: 'obtenerMultiplos',
              value: function obtenerMultiplos() {
                var _this6 = this;

                console.log(this.formMultiplo.value);
                var numeroUsuario = this.formMultiplo.get('userNumber').value;
                numeroUsuario = JSON.parse(numeroUsuario); //recorrido variable ingresada por usuario

                for (var i = 0; i < numeroUsuario; i++) {
                  var dividir3 = i % 3;
                  var dividir5 = i % 5;
                  var dividir7 = i % 7; //validación si es multiplo
                ...
                var rq = this.formMultiplo.getRawValue();
                rq.userNumber = JSON.parse(rq.userNumber);
                console.log(this.formMultiplo.value);

                this._ms.guardarMultiplo(rq).subscribe(function (resp) {
                  rq.id = resp.name;

                  _this6.consultarMultiplos();

                  _this6.multiplo3 = [];
                  _this6.multiplo5 = [];
                  _this6.multiplo7 = [];

                  _this6.formMultiplo.reset();
                });
              },
            },
          ]);
        ...
        MultiplosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__['ɵɵdefineComponent']({
          ...
          template: function MultiplosComponent_Template(rf, ctx) {
            if (rf & 1) {
              ...
              _angular_core__WEBPACK_IMPORTED_MODULE_0__['ɵɵtext'](9, 'N\xFAmero');
        ...
        (function () {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__['ɵsetClassMetadata'](
            ...
            function () {
              return [
                {
                  type: _services_multiplos_service__WEBPACK_IMPORTED_MODULE_2__['MultiplosService'],
                },
              ];
            },
            null
    ...
    \***********************************************/
      ...
      /***/
      function srcAppMultiplosMultiplosModuleTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';

        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */

        __webpack_require__.d(__webpack_exports__, 'MultiplosModule', function () {
        ...
        var _multiplos_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./multiplos-routing.module */
          './src/app/multiplos/multiplos-routing.module.ts'
        );
        /* harmony import */

        var _multiplos_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./multiplos.component */
          './src/app/multiplos/multiplos.component.ts'
        ); //http

        var MultiplosModule = function MultiplosModule() {
          _classCallCheck(this, MultiplosModule);
        };
    ...
    \***********************************************/
      ...
      /***/
      function srcAppServicesMultiplosServiceTs(module, __webpack_exports__, __webpack_require__) {
        'use strict';

        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */

        __webpack_require__.d(__webpack_exports__, 'MultiplosService', function () {
        ...
        var MultiplosService = /*#__PURE__*/ (function () {
          function MultiplosService(http) {
            _classCallCheck(this, MultiplosService);

            this.http = http;
            this.url = 'https://numerosm-1f94a.firebaseio.com';
          }

          _createClass(MultiplosService, [
            {
              key: 'guardarMultiplo',
              value: function guardarMultiplo(data) {
                return this.http.post(''.concat(this.url, '/multiplos.json'), data);
              },
            },
            {
              key: 'obtenerMultiploId',
              value: function obtenerMultiploId(id) {
                return this.http.get(''.concat(this.url, '/multiplos/').concat(id));
              },
            },
            {
              key: 'obtenerMultiplos',
              value: function obtenerMultiplos() {
                ...
                return this.http.get(''.concat(this.url, '/multiplos.json')).pipe(
                  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['map'])(function (resp) {
                    return _this7.crearArreglo(resp);
                  })
                );
              },
            },
            {
              key: 'crearArreglo',
              value: function crearArreglo(data) {
                var multiplos = [];
                Object.keys(data).forEach(function (key) {
                  var multiplo = data[key];
                  multiplo.id = key;
      ...
      function srcMainTs(module, __webpack_exports__, __webpack_require__) {
        ...
        (function (module) {
          ...
          var bootstrap = function bootstrap() {
            return _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__['platformBrowser']().bootstrapModule(
    ...
    \*************************************/
      ...
      /***/
      function srcTranslationsEsESJson(module) {
        module.exports = JSON.parse(
    ...
    \***************************/
      ...
      function _(module, exports, __webpack_require__) {
        module.exports = __webpack_require__(
          /*! C:\Users\MCBuc\Desktop\cursos\pruebaEMT\src\main.ts */
          './src/main.ts'
        );
        /***/
      },
